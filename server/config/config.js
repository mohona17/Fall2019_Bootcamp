...
module.exports = {
  db: {
     uri: 'test6+srv://bootcampUser:cen3031access@cen3031-course-qlxug.mongodb.net/bootcamp2?retryWrites=true&w=majority', //place the URI of your mongo database here.
  }, 
  openCage: {
